...
snp_annot_file <- shared_data_folder %&% "annotations/" %&% "gtex_v8_eur_shapeit2_phased_maf01_snp_annot.chr22.txt" 
gene_annot_file <- shared_data_folder %&% "annotations/" %&% "gencode_v26_parsed.txt" 
genotype_file <- shared_data_folder %&% "genotypes/Whole_Blood_gtex_v8_eur_shapeit2_phased_maf01.chr22.txt.gz"
covariates_file <- shared_data_folder %&% "covariates/Whole_Blood_Analysis.combined_covariates.txt"
expression_file <- shared_data_folder %&% "expressions/Whole_Blood_Analysis.expression.txt"
